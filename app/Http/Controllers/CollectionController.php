...
class CollectionController extends Controller
{
    ...
    public function collectionReceiptGeneratePDF($session, $class, $section, $date_from, $date_to)
    {
        ...
        $pdf = PDF::loadView('collection.pdf.collectionreceipt', ['feecollections' => $feecollections, 'usedstudentids' => $used_student_ids], ['data' => [$session, $class, $section, $date_from, $date_to]], ['mode' => 'utf-8', 'format' => 'A4-L']);
        $fileName = 'Collection_List_Report' . '.pdf';
        return $pdf->stream($fileName); // stream, download
    }
}
